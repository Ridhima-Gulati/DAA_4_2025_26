...
<meta name="verify-admitad" content="fb09364f2b">
    ...
    <link rel="stylesheet" href="./Experiment-3_files/bootstrap.min.css">

    
    <link rel="stylesheet" href="./Experiment-3_files/onlinegdb.css">
    
    
    <script async="" src="./Experiment-3_files/clarity.js.download"></script><script async="" src="./Experiment-3_files/ew6y4c1gqd"></script><script type="text/javascript" async="" src="./Experiment-3_files/js"></script><script async="" src="./Experiment-3_files/gtm.js.download"></script><script>  var main_ide =  true;  </script>

    
    <script type="text/javascript" src="./Experiment-3_files/onlinegdb.js.download"></script><style type="text/css">  .JColResizer{table-layout:fixed;} .JColResizer > tbody > tr > td, .JColResizer > tbody > tr > th{overflow:hidden}  .JPadding > tbody > tr > td, .JPadding > tbody > tr > th{/*padding-left:0!important; */padding-right:0!important;} .JCLRgrips{ height:0px; position:relative;} .JCLRgrip{margin-left:-5px; position:absolute; z-index:5; } .JCLRgrip .JColResizer{position:absolute;background-color:red;filter:alpha(opacity=1);opacity:0;width:10px;height:100%;cursor: col-resize;top:0px} .JCLRLastGrip{position:absolute; width:1px; } .JCLRgripDrag{ border-left:1px dotted black;	} .JCLRFlex{width:auto!important;} .JCLRgrip.JCLRdisabledGrip .JColResizer{cursor:default; display:none;}</style>
    <script type="text/javascript" src="./Experiment-3_files/ace.js.download"></script>
    <script type="text/javascript" src="./Experiment-3_files/ext-language_tools.js.download"></script>
    <script type="text/javascript" src="./Experiment-3_files/editor.js.download" defer=""></script>
    <script type="text/javascript" src="./Experiment-3_files/main.js.download" defer=""></script>
    
    
    <link rel="stylesheet" href="./Experiment-3_files/bootstrap-select.min.css">
    <script src="./Experiment-3_files/bootstrap-select.min.js.download"></script>
    ...
    </script><script type="text/javascript" async="" src="./Experiment-3_files/onlinegdb(1).js.download"></script>
    <script type="text/javascript" src="./Experiment-3_files/monetization.js.download"></script>
...
<center>
    ...
    <script async="" type="text/javascript" src="./Experiment-3_files/carbon.js.download" id="_carbonads_js"></script><div id="carbonads"><span>
...
<span class="carbon-wrap">
	<a href="https://srv.carbonads.net/ads/click/x/GTND427NF6SDLKQUCAYLYKQUCYAIT5QUCKAILZ3JCASDE5QNCESIP23KC6BD4K7UCTSDKK7UCASD5K3WFTSDCK7JHEYI52J7CYSI5KJECTNCYBZ52K" class="carbon-img" target="_blank" rel="noopener sponsored">
		<img src="./Experiment-3_files/1c7b533c9d904f5ac781ebc3e53a2e503ca9bf96" alt="ads via Carbon" border="0" style="background: rgb(255, 255, 255); width: 100px; padding: 30px 15px; box-sizing: content-box; max-width: 130px;" data-no-statview="no">
	</a>
	<a href="https://srv.carbonads.net/ads/click/x/GTND427NF6SDLKQUCAYLYKQUCYAIT5QUCKAILZ3JCASDE5QNCESIP23KC6BD4K7UCTSDKK7UCASD5K3WFTSDCK7JHEYI52J7CYSI5KJECTNCYBZ52K" class="carbon-text" target="_blank" rel="noopener sponsored">
		Our Auth0 plans just got a major boost! Enjoy Custom Domain, Passwordless, and up to 25,000 MAUs.
	</a>
</span>
...
<span style="float:none;clear:both">© 2016 - 2026 GDB Online</span>
</div>
        </footer>
    ...
    <div class="split-pane-component" id="right-component">
        ...
        <script src="./Experiment-3_files/js-dos.js.download"></script>
        ...
        <div class="split-pane fixed-left" id="ide-split-pane" style="min-width: 1px;">
            <div class="split-pane-component" id="right-left-component" style="width: 100%;">
                <div class="split-pane fixed-top" style="min-height: 7px;">
                    <div class="split-pane-component" id="top-component" style="height: 75%;">
                        <!-- middle top start --> 
            ...
            <span class="col-sm-63" id="control-bar" style="float:left">
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="https://www.onlinegdb.com/online_c++_compiler#" onclick="ide.runcode({graphics:true}); track_event(&#39;run_gui&#39;,&#39;run_gui&#39;)">Run with display screen (beta)</a></li>
                    </ul>
                </div>
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="https://www.onlinegdb.com/online_c++_compiler#" onclick="downloadCode(true)">Download all files</a></li>
                    </ul>
                </div>
...
<!--                  <option  value="c++11">C++ 11</option> -->
                  ...
                  <option value="c#">C# (mono)</option>
                  <option value="c#_dotnet">C# (dotnet)</option>
                  ...
                  <option value="pascalabc.net">PascalABC.NET</option>
                  ...
                  <option value="nasm">Assembly (NASM)</option>
    ...
    <div style="clear:both; background-color:#757575; overflow: auto; scrollbar-width: none;">
        <ul class="editor_file_tabs nav nav-pills" style="display: inline-flex;  overflow-x: scroll; overflow-y: hidden; height: 100px;">
            ...
            <li class="active">
                <a href="https://www.onlinegdb.com/online_c++_compiler#editor_1" data-toggle="tab"><span class="filename">main.cpp</span>
                </a>
    ...
    <div class="editor_text_panes tab-content clearfix">
        ...
        <div id="editor_1" data-format="S" data-readonly-ranges="" class="tab-pane active editor ace_editor ace_hidpi ace-idle-fingers ace_dark" style="font-size: medium;" draggable="false"><textarea class="ace_text-input" wrap="off" autocorrect="off" autocapitalize="off" spellcheck="false" style="opacity: 0; font-size: 1px; height: 1px; width: 1px; transform: translate(143px, 187px);"></textarea><div class="ace_gutter" aria-hidden="true" style="left: 0px; width: 51px;"><div class="ace_layer ace_gutter-layer ace_folding-enabled" style="height: 1e+06px; transform: translate(0px, -649px); width: 51px;"><div class="ace_gutter-cell " style="height: 19px; top: 646px;">35<span style="display: none; height: 19px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 19px; top: 665px;">36<span class="ace_fold-widget ace_start ace_open" style="height: 19px; display: none;"></span></div><div class="ace_gutter-cell " style="height: 19px; top: 684px;">37<span style="display: none; height: 19px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 19px; top: 703px;">38<span style="display: inline-block; height: 19px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 19px; top: 722px;">39<span style="display: none; height: 19px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 19px; top: 741px;">40<span style="display: none; height: 19px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 19px; top: 760px;">41<span style="display: none; height: 19px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 19px; top: 779px;">42<span style="display: none; height: 19px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 19px; top: 798px;">43<span style="display: none; height: 19px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-active-line ace_gutter-cell " style="height: 19px; top: 817px;">44<span style="display: none; height: 19px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 19px; top: 836px;">45<span style="display: none; height: 19px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 19px; top: 855px;">46<span style="display: none; height: 19px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 19px; top: 874px;">47<span style="display: none; height: 19px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 19px; top: 893px;">48<span style="display: none; height: 19px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 19px; top: 912px;">49<span style="display: inline-block; height: 19px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 19px; top: 931px;">50<span style="display: inline-block; height: 19px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 19px; top: 950px;">51<span style="display: none; height: 19px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 19px; top: 969px;">52<span style="display: none; height: 19px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 19px; top: 988px;">53<span style="display: none; height: 19px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 19px; top: 1007px;">54<span style="display: none; height: 19px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 19px; top: 1026px;">55<span style="display: inline-block; height: 19px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 19px; top: 1045px;">56<span style="display: none; height: 19px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 19px; top: 1064px;">57<span style="display: none; height: 19px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 19px; top: 1083px;">58<span style="display: none; height: 19px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 19px; top: 1102px;">59<span style="display: none; height: 19px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 19px; top: 1121px;">60<span style="display: none; height: 19px;" class="ace_fold-widget ace_start ace_open"></span></div></div></div><div class="ace_scroller" style="line-height: 19px; left: 51px; right: 15px; bottom: 0px;"><div class="ace_content" style="transform: translate(0px, -3px); width: 958px; height: 485px;"><div class="ace_layer ace_print-margin-layer"><div class="ace_print-margin" style="left: 708px; visibility: visible;"></div></div><div class="ace_layer ace_marker-layer"><div class="ace_active-line" style="height: 19px; top: 171px; left: 0px; right: 0px;"></div></div><div class="ace_layer ace_text-layer" style="height: 1e+06px; margin: 0px 4px; transform: translate(0px, -646px);"><div class="ace_line" style="height: 19px; top: 646px;">    <span class="ace_keyword ace_control">return</span> <span class="ace_constant ace_language">false</span><span class="ace_punctuation ace_operator">;</span></div><div class="ace_line" style="height: 19px; top: 665px;"><span class="ace_paren ace_rparen">}</span></div><div class="ace_line" style="height: 19px; top: 684px;"></div><div class="ace_line" style="height: 19px; top: 703px;"><span class="ace_storage ace_type">int</span> <span class="ace_identifier">main</span><span class="ace_paren ace_lparen">(</span><span class="ace_paren ace_rparen">)</span> <span class="ace_paren ace_lparen">{</span></div><div class="ace_line" style="height: 19px; top: 722px;">    <span class="ace_identifier">cout</span><span class="ace_keyword ace_operator">&lt;&lt;</span><span class="ace_string ace_start">"</span><span class="ace_string">Enter value of n </span><span class="ace_string ace_end">"</span><span class="ace_punctuation ace_operator">;</span></div><div class="ace_line" style="height: 19px; top: 741px;">    <span class="ace_identifier">cin</span> <span class="ace_keyword ace_operator">&gt;&gt;</span> <span class="ace_identifier">n</span><span class="ace_punctuation ace_operator">;</span></div><div class="ace_line" style="height: 19px; top: 760px;"></div><div class="ace_line" style="height: 19px; top: 779px;">    </div><div class="ace_line" style="height: 19px; top: 798px;">    <span class="ace_identifier">board</span><span class="ace_punctuation ace_operator">.</span><span class="ace_identifier">assign</span><span class="ace_paren ace_lparen">(</span><span class="ace_identifier">n</span><span class="ace_punctuation ace_operator">,</span> <span class="ace_identifier">vector</span><span class="ace_keyword ace_operator">&lt;</span><span class="ace_storage ace_type">int</span><span class="ace_keyword ace_operator">&gt;</span><span class="ace_paren ace_lparen">(</span><span class="ace_identifier">n</span><span class="ace_punctuation ace_operator">,</span> <span class="ace_constant ace_numeric">0</span><span class="ace_paren ace_rparen">))</span><span class="ace_punctuation ace_operator">;</span></div><div class="ace_line" style="height: 19px; top: 817px;">    <span class="ace_identifier">colUsed</span><span class="ace_punctuation ace_operator">.</span><span class="ace_identifier">assign</span><span class="ace_paren ace_lparen">(</span><span class="ace_identifier">n</span><span class="ace_punctuation ace_operator">,</span> <span class="ace_constant ace_numeric">0</span><span class="ace_paren ace_rparen">)</span><span class="ace_punctuation ace_operator">;</span></div><div class="ace_line" style="height: 19px; top: 836px;">    <span class="ace_identifier">diag1</span><span class="ace_punctuation ace_operator">.</span><span class="ace_identifier">assign</span><span class="ace_paren ace_lparen">(</span><span class="ace_constant ace_numeric">2</span> <span class="ace_keyword ace_operator">*</span> <span class="ace_identifier">n</span> <span class="ace_keyword ace_operator">-</span> <span class="ace_constant ace_numeric">1</span><span class="ace_punctuation ace_operator">,</span> <span class="ace_constant ace_numeric">0</span><span class="ace_paren ace_rparen">)</span><span class="ace_punctuation ace_operator">;</span></div><div class="ace_line" style="height: 19px; top: 855px;">    <span class="ace_identifier">diag2</span><span class="ace_punctuation ace_operator">.</span><span class="ace_identifier">assign</span><span class="ace_paren ace_lparen">(</span><span class="ace_constant ace_numeric">2</span> <span class="ace_keyword ace_operator">*</span> <span class="ace_identifier">n</span> <span class="ace_keyword ace_operator">-</span> <span class="ace_constant ace_numeric">1</span><span class="ace_punctuation ace_operator">,</span> <span class="ace_constant ace_numeric">0</span><span class="ace_paren ace_rparen">)</span><span class="ace_punctuation ace_operator">;</span></div><div class="ace_line" style="height: 19px; top: 874px;"></div><div class="ace_line" style="height: 19px; top: 893px;">    </div><div class="ace_line" style="height: 19px; top: 912px;">    <span class="ace_keyword ace_control">if</span> <span class="ace_paren ace_lparen">(</span><span class="ace_identifier">solve</span><span class="ace_paren ace_lparen">(</span><span class="ace_constant ace_numeric">0</span><span class="ace_paren ace_rparen">))</span> <span class="ace_paren ace_lparen">{</span></div><div class="ace_line" style="height: 19px; top: 931px;"><span class="ace_indent-guide">    </span>    <span class="ace_keyword ace_control">for</span> <span class="ace_paren ace_lparen">(</span><span class="ace_storage ace_type">int</span> <span class="ace_identifier">i</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_constant ace_numeric">0</span><span class="ace_punctuation ace_operator">;</span> <span class="ace_identifier">i</span> <span class="ace_keyword ace_operator">&lt;</span> <span class="ace_identifier">n</span><span class="ace_punctuation ace_operator">;</span> <span class="ace_identifier">i</span><span class="ace_keyword ace_operator">++</span><span class="ace_paren ace_rparen">)</span> <span class="ace_paren ace_lparen">{</span></div><div class="ace_line" style="height: 19px; top: 950px;"><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span>    <span class="ace_keyword ace_control">for</span> <span class="ace_paren ace_lparen">(</span><span class="ace_storage ace_type">int</span> <span class="ace_identifier">j</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_constant ace_numeric">0</span><span class="ace_punctuation ace_operator">;</span> <span class="ace_identifier">j</span> <span class="ace_keyword ace_operator">&lt;</span> <span class="ace_identifier">n</span><span class="ace_punctuation ace_operator">;</span> <span class="ace_identifier">j</span><span class="ace_keyword ace_operator">++</span><span class="ace_paren ace_rparen">)</span></div><div class="ace_line" style="height: 19px; top: 969px;"><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span>    <span class="ace_identifier">cout</span> <span class="ace_keyword ace_operator">&lt;&lt;</span> <span class="ace_identifier">board</span><span class="ace_paren ace_lparen">[</span><span class="ace_identifier">i</span><span class="ace_paren ace_rparen">]</span><span class="ace_paren ace_lparen">[</span><span class="ace_identifier">j</span><span class="ace_paren ace_rparen">]</span> <span class="ace_keyword ace_operator">&lt;&lt;</span> <span class="ace_string ace_start">"</span><span class="ace_string"> </span><span class="ace_string ace_end">"</span><span class="ace_punctuation ace_operator">;</span></div><div class="ace_line" style="height: 19px; top: 988px;"><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span>    <span class="ace_identifier">cout</span> <span class="ace_keyword ace_operator">&lt;&lt;</span> <span class="ace_string ace_start">"</span><span class="ace_constant ace_language ace_escape">\n</span><span class="ace_string ace_end">"</span><span class="ace_punctuation ace_operator">;</span></div><div class="ace_line" style="height: 19px; top: 1007px;"><span class="ace_indent-guide">    </span>    <span class="ace_paren ace_rparen">}</span></div><div class="ace_line" style="height: 19px; top: 1026px;">    <span class="ace_paren ace_rparen">}</span> <span class="ace_keyword ace_control">else</span> <span class="ace_paren ace_lparen">{</span></div><div class="ace_line" style="height: 19px; top: 1045px;"><span class="ace_indent-guide">    </span>    <span class="ace_identifier">cout</span> <span class="ace_keyword ace_operator">&lt;&lt;</span> <span class="ace_string ace_start">"</span><span class="ace_string">No solution exists</span><span class="ace_constant ace_language ace_escape">\n</span><span class="ace_string ace_end">"</span><span class="ace_punctuation ace_operator">;</span></div><div class="ace_line" style="height: 19px; top: 1064px;">    <span class="ace_paren ace_rparen">}</span></div><div class="ace_line" style="height: 19px; top: 1083px;"></div><div class="ace_line" style="height: 19px; top: 1102px;">    <span class="ace_keyword ace_control">return</span> <span class="ace_constant ace_numeric">0</span><span class="ace_punctuation ace_operator">;</span></div></div><div class="ace_layer ace_marker-layer"></div><div class="ace_layer ace_cursor-layer ace_hidden-cursors"><div class="ace_cursor" style="display: block; transform: translate(92px, 171px); width: 9px; height: 19px; animation-duration: 1000ms;"></div></div></div></div><div class="ace_scrollbar ace_scrollbar-v" style="width: 20px; bottom: 0px;"><div class="ace_scrollbar-inner" style="width: 20px; height: 1159px;">&nbsp;</div></div><div class="ace_scrollbar ace_scrollbar-h" style="display: none; height: 20px; left: 51px; right: 15px;"><div class="ace_scrollbar-inner" style="height: 20px; width: 958px;">&nbsp;</div></div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font: inherit; overflow: hidden;"><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font: inherit; overflow: visible;">הההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההה</div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font-style: inherit; font-variant: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; font-family: inherit; font-optical-sizing: inherit; font-size-adjust: inherit; font-kerning: inherit; font-feature-settings: inherit; font-variation-settings: inherit; font-language-override: inherit; overflow: visible;"></div></div></div>
        
    </div>
    <div id="sidebar_adunit_wrapper">
        <div class="col-sm-12 text-right" style="padding-bottom: 10px; z-index:9">
        <a href="https://www.onlinegdb.com/online_c++_compiler#" onclick="hide_sidebar_adunit_wrapper();" style="color:white;"> close ad [x]</a></div>
...
<style>
    ...
    <div id="bsa-zone_1734365016557-4_123456"><div id="bsa-zone_1734365016557-4_123456_direct_iframe_container" style="border: 0px;"><div id="vdzw_FJFA"><div data-view="wrapper" style="position: relative; overflow: hidden;"><div data-view="placehodler" style="z-index: 10; position: relative; margin: 0px auto; transition: height 300ms; height: 0px; width: 300px;"><div class="_3e6HH" style="background-color: rgba(0, 0, 0, 0.7);"><div class="_qEIzW" style="color: #757575; border-color: #757575;">Ad</div></div></div><div data-view="slider" style="z-index: 5; display: flex; align-items: center; justify-content: flex-start; flex-direction: column; position: absolute; width: 100%; height: 100%; top: 0px; left: 0px;"><div data-view="panel" style="width: 100%;"></div><div data-view="player" style="width: 300px; height: 168px;"><div id="el_fCJE9gP7"><div class="sbt" style="width: 300px; height: 168px;"><div class="sbt-wrapper"><div class="sbt-placeholder"><div class="sbt-ima-container" style="z-index: 1;"></div><div id="sbt-stream-rt3a" style="background-color: rgb(0, 0, 0); background-position: center center; background-repeat: no-repeat; background-size: contain; background-image: url(&quot;https://inventory.vidazoo.com/660962f8e20c308b326e8fec/660962fa8e5de3473dea7b36/660962fa8e5de3473dea7b36.jpg&quot;); cursor: pointer; z-index: 2;"></div></div></div><iframe marginwidth="0" marginheight="0" frameborder="0" scrolling="no" style="width: 1px; height: 1px; position: absolute;" src="./Experiment-3_files/saved_resource.html"></iframe><div class="gOPMi">
                <div class="HdBoD">
                    <div class="LLNfo">
            ...
            </div></div></div></div><div data-no-gesture="true" data-view="close-button" class="_dkzHn" style="background-color: transparent; border: none; color: rgb(208, 208, 208); font-size: 17px; height: 15px; width: 15px; display: none;">×</div></div></div></div><script data-widget-id="676040945fb0474242dede3c" data-jsonp="__vdzw_676040945fb0474242dede3c_z2G4_jsonp_" id="" src="./Experiment-3_files/widget.js.download"></script><script id="" src="./Experiment-3_files/sbt.js.download"></script><iframe id="bsa-zone_1734365016557-4_123456_direct_iframe" frameborder="0" scrolling="no" width="1" height="1" src="./Experiment-3_files/saved_resource(1).html"></iframe></div></div></div>
</div> 
</div>
                        <!-- middle top end -->
                    </div>
                    <div class="split-pane-divider" id="my-divider1" style="top: 75%;"><div class="split-pane-divider-inner"></div></div>
                    <div class="split-pane-component" id="bottom-component" style="top: 75%;">
    ...
    <div id="console-fadder" style="display: none;">
        <center><img src="./Experiment-3_files/loading.gif"><img>
    ...
    <div id="console-content" class="tab-content">
        <div id="tab-stdin" class="tab-pane fade active in" style="display: block;">
            ...
            <div id="interactive-terminal-container" style="position:absolute; margin:0px;top:0px; bottom:0px; left:0px; right:0px;" class="col-sm-121"><div dir="ltr" class="terminal xterm" tabindex="0" role="document"><div class="xterm-viewport" style="background-color: rgb(0, 0, 0);"><div class="xterm-scroll-area" style="height: 162px;"></div></div><div class="xterm-screen" style="width: 988px; height: 126px;"><div class="xterm-helpers"><textarea class="xterm-helper-textarea" aria-label="Terminal input" aria-multiline="false" autocorrect="off" autocapitalize="off" spellcheck="false" tabindex="0" style="left: 252.292px; top: 108px; width: 9.01042px; height: 18px; line-height: 18px; z-index: -5;"></textarea><span class="xterm-char-measure-element" aria-hidden="true" style="font-family: courier-new, courier, monospace; font-size: 15px;">W</span><div class="composition-view"></div></div><canvas class="xterm-text-layer" style="z-index: 0; width: 988px; height: 126px;" width="1482" height="189"></canvas><canvas class="xterm-selection-layer" style="z-index: 1; width: 988px; height: 126px;" width="1482" height="189"></canvas><canvas class="xterm-link-layer" style="z-index: 2; width: 988px; height: 126px;" width="1482" height="189"></canvas><canvas class="xterm-cursor-layer" style="z-index: 3; width: 988px; height: 126px;" width="1482" height="189"></canvas></div></div></div>
...
<div id="debugger-value-tooltip"></div> 
                <!-- right component end -->
            </div>
        </div>
...
<!--<script src="//control.mockingfish.com/js/011503.js"></script>-->
    ...
    <div id="serverDisconnectedModal" class="modal fade" role="dialog" style="display: none;">
        <div class="modal-dialog">
            <!-- Modal content-->
            <div class="modal-content">
                <div class="modal-header">
